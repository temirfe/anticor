...
public class DocListActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(query!=null){
            ...
            builder.scheme(Endpoints.SCHEME).authority(Endpoints.AUTHORITY).appendPath(Endpoints.API).appendPath("documents");
    ...
    public void populateList(final int page,Uri.Builder urlB, final boolean applyNewFilter, final boolean newlist){
        ...
        if(uriB==null){
            ...
            uriB.scheme(Endpoints.SCHEME).authority(Endpoints.AUTHORITY).appendPath(Endpoints.API).appendPath("documents");
        }
